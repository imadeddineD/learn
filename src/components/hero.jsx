      ...
      <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[650px] relative">
        ...
        <div className="flex flex-col justify-center py-14 md:pr-16 xl:pr-40 md:py-0">
          <div className="text-center md:text-left space-y-6">
            ...
            >
              Discover Your Perfect Tutor with <span className="text-primary">Learn</span>
            </motion.h1>
            <motion.p
              ...
              animate="visible"
            >
              We assist you in finding the ideal tutor for personalized one-on-one lessons, completely free and fully confidential.
            </motion.p>
            {/* button section */}
            <motion.div
            ...
            >
              <button className="primary-btn"><a href="/auth/register">Get Started</a></button>
